...
class PodcastsControllerTest < ActionController::TestCase
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post :create, podcast: { audio: @podcast.audio, description: @podcast.description, showID: @podcast.showID, title: @podcast.title, userID: @podcast.userID }
    end
  ...
  test "should update podcast" do
    patch :update, id: @podcast, podcast: { audio: @podcast.audio, description: @podcast.description, showID: @podcast.showID, title: @podcast.title, userID: @podcast.userID }
    assert_redirected_to podcast_path(assigns(:podcast))
  end
